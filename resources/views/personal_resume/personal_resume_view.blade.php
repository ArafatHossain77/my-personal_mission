...
<div class="container">
    <nav class="navbar bg-primary" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Resume View File</a>
...
<div class="container mt-5">
    <div class="card mb-3 mt-5 p-5">
        ...
        <div class="card-body">
            ...
            <a href="{{route('personalResumeInfo')}}" class="btn btn-primary">Click Hare</a>
        </div>
    </div>
    ...
    <div class="card mb-4" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="{{route('personalResumeOutput')}}" class="btn btn-info">View Your CV</a>
        </div>
    </div>
</div>
