...
<div class="container">
    <nav class="navbar bg-primary" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Add Your Resume Info</a>
...
<div class="item">
    <div class="container mt-5">
        <div class="card mt-5 mb-3">
            <div class="card-body">
                <h3 class="text-uppercase text-center mb-5">Resume Info Desk</h3>
                <form method="POST" action='{{route('storeResumeData')}}'>
                    @csrf
                    <div class="item p-2">
