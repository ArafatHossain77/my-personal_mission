                        ...
                        <div class="card-body mb-5 p-5">
                            ...
                            <form method="POST" action='{{route('storeData')}}'>
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="email" value="{{request()->email}}" name="email" id="form3Example3cg"
                                           class="form-control form-control-lg" placeholder="@gmail.com"/>
                                </div>
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="date" value="{{request()->dob}}" name="dob" id="form3Example1cg"
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="password" value="{{request()->password}}" name="password"
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="password" value="{{request()->confirm_password}}"
                                           name="confirm_password" id="form3Example4cdg"
