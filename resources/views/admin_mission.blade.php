...
<div class="container">
    <nav class="navbar bg-primary navbar-fixed-top" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">AdminProfile</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{route('admin_dashboard')}}">Admin Profile</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="row g-0">
                                <div class="col-md-8">
                                    <div class="container">
                                        <p>
                                        <div class="container-fluid">
                                            <form method="POST" action="{{route('personalMissionCreateAdmin')}}">
                                                @csrf
