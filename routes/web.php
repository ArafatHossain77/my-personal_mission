...
Route::get('/edit_resume', [App\Http\Controllers\UsersController::class, 'editResume'])->name('editResume');
Route::delete('/delete_resume/{id}', [App\Http\Controllers\UsersController::class, 'destroyResume'])->name('destroyResume');
